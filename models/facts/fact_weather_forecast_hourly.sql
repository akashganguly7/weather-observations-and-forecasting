-- Fact table for weather forecast data at postal code level
-- This model joins staging forecast data with dimensions and spatial linking to get postal code level data
...
SELECT 
    ...
    sf.outlier_flag,
    sf.confidence_score
FROM {{ ref('stg_weather_forecast_hourly') }} sf
