-- Aggregated weather forecast data by postal code
-- This model creates aggregated statistics for weather forecast data grouped by postal code and timestamp
...
SELECT 
    ...
    MAX(fwf.load_dts) as load_dts
    
FROM {{ ref('fact_weather_forecast_hourly') }} fwf
