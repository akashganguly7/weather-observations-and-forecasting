-- Weather observed data transformation with outlier handling
-- This model extracts and standardizes weather parameters from raw JSON data
...
WITH deduplicated_weather AS (
    ...
    FROM {{ source('raw', 'weather_hourly_observed_raw') }}
